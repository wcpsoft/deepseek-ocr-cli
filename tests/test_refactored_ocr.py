...
from src.core.utils.exception_handler import ExceptionHandler, MemoryException
...
def test_ocr_service():
    ...
    try:
        ...
        logger.error(f"测试OCR服务时发生错误: {str(e)}")
        raise
...
def test_image_processing():
    ...
    try:
        ...
        logger.error(f"测试图像处理时发生错误: {str(e)}")
        raise
