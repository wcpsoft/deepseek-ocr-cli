...
def test_gpu_detection_imports():
    ...
    try:
        from dev.detect_gpu import get_extra_require_suffix, get_gpu_type
...
def test_gpu_detection_functions():
    ...
    try:
        ...
        for gpu_type, expected_suffix in test_cases:
            ...
            ), f"GPU类型 {gpu_type} 的依赖后缀不正确: 期望 {expected_suffix}, 实际 {suffix}"
...
def test_installation_command_generation():
    ...
    try:
        from dev.detect_gpu import get_extra_require_suffix, get_pytorch_install_cmd
