...
def draw_bounding_boxes(
    image: Image.Image, cor_list: list, label_type: str, output_path: Optional[str] = None
) -> Image.Image:
    """
    在图像上绘制边界框
...
def save_ocr_results(
    outputs: str, image_draw: Image.Image, output_path: str, default_filename: str = "result.mmd"
) -> None:
    """
