...
from src.core.multimodal.ocr_result_processor import BatchOCRProcessor, OCRResultProcessor
...
class OCRService:
    ...
    def __init__(self, engine: OCREngineInterface, output_dir: Optional[str] = None):
        """
        初始化OCR服务
    ...
    def process_image(self, image: Union[Image.Image, str], prompt: Optional[str] = None) -> str:
        """
        处理单个图像
    ...
    def process_images(self, images: List[Union[Image.Image, str]], 
    ...
    def _load_image_from_path(self, image_path: str) -> Image.Image:
        ...
        try:
            ...
            logger.error(f"加载图像失败: {image_path}, 错误: {str(e)}")
            raise
    ...
    def _process_batch_with_engine(self, images: List[Image.Image], 
                                  prompts: List[str], 
    ...
    def cleanup(self) -> None:
        ...
        try:
            ...
            logger.error(f"清理OCR服务资源时发生错误: {str(e)}")
