...
class OCREngineFactory:
    ...
    @classmethod
    def create_engine(cls, engine_type: Optional[str] = None, **kwargs) -> Any:
        """
        创建OCR引擎
        ...
        try:
            ...
            logger.error(f"创建OCR引擎失败: {engine_type}, 错误: {str(e)}")
            raise
...
def _register_engines():
    ...
    try:
        ...
        logger.warning(f"无法注册Transformers引擎: {str(e)}")
    ...
    try:
        ...
        logger.warning(f"无法注册vLLM引擎: {str(e)}")
