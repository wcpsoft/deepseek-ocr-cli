...
# 配置导入
from src.core.config import BASE_SIZE, CROP_MODE, IMAGE_SIZE
...
class MultimodalProcessor:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            # 获取统一的加载参数，tokenizer 不需要 trust_remote_code
            ...
            logger.error(f"初始化统一多模态处理器失败: {e!s}")
            return False
...
if VLLM_AVAILABLE:
    ...
    class UnifiedDeepseekOCRMultiModalProcessor(BaseMultiModalProcessor[DeepseekOCRProcessingInfo]):
        """
