...
class BasicImageTransform(BaseTransform):
    def __init__(
        self,
        mean: tuple[float, float, float] | None = (0.5, 0.5, 0.5),
        std: tuple[float, float, float] | None = (0.5, 0.5, 0.5),
        normalize: bool = True,
    ):
        self.mean = mean
        self.std = std
